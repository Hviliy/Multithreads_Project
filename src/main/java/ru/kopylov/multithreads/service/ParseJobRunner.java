    ...
    public void run(UUID jobId, String url) {
        ...
        try {
            ...
            if (!errors.isEmpty()) {
                ...
                throw new RuntimeException("Ошибки при загрузке страниц (первая): " + first, first);
            }
            ...
            asyncEventLogger.logEvent("Отзывы сохранены в БД: saved=" +
                    batch.size() + ", id=" + jobId);
